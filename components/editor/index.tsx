...
const PROMPT = `Given the job title "{jobTitle}", please create 6-7 concise and personal bullet 
points in HTML stringify format that highlight my key skills, relevant technologies, 
and significant contributions in that role. Do not include the job position title itself in the output.
Please provide only the bullet points inside an unordered list.`;
